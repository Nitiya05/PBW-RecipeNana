        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-20 border border-blue-300 shadow rounded-md">
                    <!-- Modal toggle -->
                    <a href="/tampilkanDataResep/{{ $item->id }}" data-modal-target="editUserModal" data-modal-show="editUserModal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5  mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Edit </a>
