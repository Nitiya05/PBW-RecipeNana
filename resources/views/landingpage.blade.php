...
@section('content')
    <div class="pt-10 bg-[442626] my-20 w-full">
        <div class="grid md:grid-cols-2 xl:mx-20 my-20 w-full">
            <div class="pl-10 my-10 sm:my-20 items-end object-left ">
                <h1 class=" mb-5 font-[arial] text-white font-extrabold tracking-tighter text-6xl">
                    Pizza Teflon</h1>
                <p class="text-white text-2xl text-justify font-Arial ml-0">
                    Pizza saat ini telah hadir dengan ragam variasi menu 
                    dan cara membuatnya. Aneka toping pilihan bisa
                    Anda taburkan di atasnya. Pizza pun tak hanya bisa 
                    dibuat dengan cara dipanggang dengan oven.
                    Faktanya, Pizza Teflon sedang populer belakangan ini.
                </p>
                <br>
                <p>
                    <a href="/resep" class ="bg-[#D9D9D9] inline block p-3 px-19 text-center text-black font-medium font-Arial ml-0">
                        Tentang Kami
                    </a>
                </p>
            </div>
            ...
            <br><br><br>
            <div>
                <img class="ml-20" src="{{('image/pizza.jpg') }}" width="450" height="900">
            </div>

        </div>
    </div>

    <div class="bg-[#442626] pt-10 w-full">
        <h1 class=" pl-20 mb-5 font-[arial] text-white font-bold tracking-tighter text-3xl">
           Resep Kami</h1>

        <div class="flex">
            <div class="text-white text-2xl text-justify font-Arial ml-20 pl-20 flex-1 w-64">
                <tr>
    ...
    <div class="bg-[B78484] w-full">
        <div class="m-auto pt-10">
            <img
            class="ml-80 pl-80"
            src="{{asset('image/title.png')}}" weight="300" height="300" />
        </div>
            <p class="text-3xl text-[#442624] text-center font-extrabold font-[arial] ">
